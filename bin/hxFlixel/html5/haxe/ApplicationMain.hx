...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("flxCornerContour", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("flxCornerContour", null, 1024, 765);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "flxCornerContour";
		app.meta["name"] = "flxCornerContour";
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("cornerContourSamples.hxFlixel.SvgExample")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess cornerContourSamples.hxFlixel.SvgExample.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"cornerContourSamples.hxFlixel.SvgExample\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"cornerContourSamples.hxFlixel.SvgExample\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends cornerContourSamples.hxFlixel.SvgExample {}
#else
class DocumentClass
{
