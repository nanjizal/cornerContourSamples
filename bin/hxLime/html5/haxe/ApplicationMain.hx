...
import cornerContourSamples.hxLime.SvgExample;
...
@:dox(hide) class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("bin.hxLime.SvgExample", create);
	...
	public static function create(config:Dynamic):Void
	{
		...
		#if !munit
		var app = new cornerContourSamples.hxLime.SvgExample();
		app.meta.set("build", "12");
		app.meta.set("company", "Nanjizal");
		app.meta.set("file", "bin.hxLime.SvgExample");
		app.meta.set("name", "CornerContourLimeTest");
		app.meta.set("packageName", "net.nanjizal.cornerContourLimeTest");
	...
	public static function start(app:lime.app.Application = null):Void
	{
		...
		new cornerContourSamples.hxLime.SvgExample();
