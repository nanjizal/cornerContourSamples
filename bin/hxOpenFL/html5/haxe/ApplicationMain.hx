...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SvgExample", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("SvgExample", null, 1024, 768);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "12";
		app.meta["company"] = "Nanjizal";
		app.meta["file"] = "SvgExample";
		app.meta["name"] = "cornerContour SVG OpenFL example";
		app.meta["packageName"] = "net.nanjizal.SvgExample";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "cornerContour SVG OpenFL example",
			width: 1024,
			x: null,
			y: null,
		};
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("cornerContourSamples.hxOpenFL.SvgExample")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess cornerContourSamples.hxOpenFL.SvgExample.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"cornerContourSamples.hxOpenFL.SvgExample\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"cornerContourSamples.hxOpenFL.SvgExample\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends cornerContourSamples.hxOpenFL.SvgExample {}
#else
class DocumentClass
{
