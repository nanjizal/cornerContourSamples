...
var cornerContourSamples_hxWebGL_SvgExample = function() {
	this.divertTrace = new cornerContour_web_DivertTrace();
	haxe_Log.trace("SVG WebGL Contour Test",{ fileName : "src/cornerContourSamples/hxWebGL/SvgExample.hx", lineNumber : 24, className : "cornerContourSamples.hxWebGL.SvgExample", methodName : "new"});
	this.width = 1024;
	this.height = 768;
	this.mainSheet = new cornerContour_web_Sheet();
	this.mainSheet.create(this.width,this.height,true);
	this.gl = this.mainSheet.gl;
	var pen2D = new cornerContour_Pen2D(-16776961);
	pen2D.currentColor = -16776961;
	var s = pen2D.arr[0] | 0;
	cornerContourSamples_svg_All_svgs(pen2D);
	var e = pen2D.arr[0] - 1 | 0;
	this.renderer = new cornerContour_web__$Renderer_Renderer_$(this.gl,pen2D,this.width,this.height);
...
cornerContourSamples_hxWebGL_SvgExample.__name__ = true;
function cornerContourSamples_hxWebGL_SvgExample_main() {
	new cornerContourSamples_hxWebGL_SvgExample();
}
...
cornerContourSamples_hxWebGL_SvgExample_main();
